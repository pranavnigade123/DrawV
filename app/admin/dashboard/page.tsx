...
function ActionButton({
  ...
  return (
    <Link
      href={href}
      className="inline-flex items-center justify-center px-3 py-2 rounded-lg border border-zinc-700 text-sm hover:bg-zinc-800 transition"
    >
      {label}
    </Link>
  )
            ...
            <div className="flex-1">
              <div className="relative">
                <input
                  ...
                  className="w-full rounded-xl border border-zinc-800 bg-zinc-900/60 px-4 py-3 outline-none focus:ring-2 focus:ring-indigo-500/30"
                />
        ...
        <div className="xl:col-span-1">
          ...
          <div className="mt-6 rounded-2xl border border-zinc-800/70 bg-zinc-900/60 p-5">
            ...
            <div className="grid grid-cols-2 gap-2">
              <Link href="/admin/tournaments/create" className="rounded-lg border border-zinc-800 px-3 py-2 text-sm hover:bg-zinc-800 transition">
                New
              </Link>
              <Link href="/admin/tournaments" className="rounded-lg border border-zinc-800 px-3 py-2 text-sm hover:bg-zinc-800 transition">
                Manage
              </Link>
              <Link href="/admin/tournaments/archived" className="rounded-lg border border-zinc-800 px-3 py-2 text-sm hover:bg-zinc-800 transition">
                Archived
              </Link>
              <Link href="/admin/users" className="rounded-lg border border-zinc-800 px-3 py-2 text-sm hover:bg-zinc-800 transition">
                Users
              </Link>
            </div>
          </div>
