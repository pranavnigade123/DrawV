      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 sm:pt-32 pb-16">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700">
                ...
                <p className="text-zinc-400 mt-2">The world's most popular engine, especially for mobile and indie games. Versatile for both 2D and 3D. Uses C#.</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700">
                <img src="ue5.png" alt="Unreal Engine" className="w-full h-auto rounded-lg mb-4"/>
                <h4 className="text-xl font-bold">Unreal Engine</h4>
                <p className="text-zinc-400 mt-2">A powerhouse known for stunning graphics. Great for AAA-style games. Uses C++ and visual Blueprints.</p>
              </div>
              <div className="bg-zinc-800/50 p-6 rounded-2xl border border-zinc-700">
                ...
                <p className="text-zinc-400 mt-2">A rising open-source star. It's lightweight, easy to use, and fantastic for 2D game development.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="text-center">
          ...
          <div className="space-y-4 max-w-2xl mx-auto">
            <a href="#" className="block p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 text-left hover:border-indigo-400 transition-colors"><strong>Unity Learn:</strong> Create with Code - The official beginner's path.</a>
            <a href="#" className="block p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 text-left hover:border-indigo-400 transition-colors"><strong>Unreal Engine:</strong> Your First Game - A step-by-step video tutorial.</a>
            <a href="#" className="block p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 text-left hover:border-indigo-400 transition-colors"><strong>freeCodeCamp:</strong> Full-length courses on YouTube.</a>
            <a href="#" className="block p-4 bg-zinc-800/50 rounded-lg border border-zinc-700 text-left hover:border-indigo-400 transition-colors"><strong>Brackeys Archive:</strong> High-quality, easy-to-follow Unity tutorials.</a>
          </div>
        </section>
